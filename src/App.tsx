...
const INITIAL_ITEMS: Omit<Item, 'id'>[] = [
  ...
  { name: "RS 90", boxPrice: 0, loosePrice: 132, defaultType: "loose" },
  ...
  { name: "ICONIQ NIP", boxPrice: 0, loosePrice: 0, defaultType: "loose" },
  { name: "ICONIQ 90", boxPrice: 0, loosePrice: 0, defaultType: "loose" },
  { name: "MS NIP", boxPrice: 0, loosePrice: 145, defaultType: "loose" },
  ...
  { name: "KF CAN", boxPrice: 3258, loosePrice: 147, defaultType: "box" },
